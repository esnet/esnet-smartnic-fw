...
├── smartnic-system-setup_0.6.0_all.deb <-- Debian package providing udev and systemd units for card management
...
``` bash
cd sn-bootstrap
sudo dpkg -i smartnic-system-setup_0.6.0_all.deb
```
