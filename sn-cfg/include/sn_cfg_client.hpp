#ifndef SN_CFG_CLIENT_HPP
#define SN_CFG_CLIENT_HPP
...
public:
    ...
    typedef std::shared_ptr<sn_cfg::v2::SmartnicConfig::Stub> Stub;

    static Stub connect(const Options& opts);
    bool is_connected() const { return _stub != nullptr; }
    SmartnicConfigClient(const Options& opts = Options()) : _stub(connect(opts)) {}

protected:
    Stub _stub;
};

#endif // SN_CFG_CLIENT_HPP
